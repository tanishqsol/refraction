...
@Component({
  selector: 'app-answer1-st2-page-rte',
  templateUrl: './answer1-st2-page-rte.component.html',
  styleUrls: ['./answer1-st2-page-rte.component.css']
})
export class Answer1St2PageRteComponent implements OnInit {
